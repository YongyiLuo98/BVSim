#!/bin/bash
#SBATCH -J CSV_benchmark
#SBATCH -N 1 -c 1
#SBATCH --mem=40G
#SBATCH --output=/storage01/users/s1155146014/TGS/code/task02/CSV_benchmark_%j.out
#SBATCH --error=/storage01/users/s1155146014/TGS/code/task02/CSV_benchmark_%j.err
#SBATCH -p chpc
...
RESULT_DIR="${RESULT_BASE}/CSV_${TIMESTAMP}"
mkdir -p ${RESULT_DIR}
