...
#SBATCH --output=/storage01/users/s1155146014/TGS/code/task04/benchmark_summary.log
...
# 基础路径
BASE_OUTPUT_DIR="/storage01/users/s1155146014/TGS/data/test_data/task04"
BASE_LOG_DIR="/storage01/users/s1155146014/TGS/code/task04"
REGION_BED_DIR="/storage01/users/s1155146014/BVSim/empirical/hg38"
