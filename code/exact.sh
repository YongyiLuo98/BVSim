...
#SBATCH -N 1 -c 1
#SBATCH --mem=40G
#SBATCH --output=/storage01/users/s1155146014/TGS/code/task02/exact_%j.out
#SBATCH --error=/storage01/users/s1155146014/TGS/code/task02/exact_%j.err
#SBATCH -p chpc
...
RESULT_DIR="${RESULT_BASE}/exact_${TIMESTAMP}"
mkdir -p ${RESULT_DIR}
...
for i in {1..10}; do
    ...
    bvsim \
        ...
        -seed ${i} \
        -rep ${i} \
        -variant_table /lustre/project/Stat/s1155146014/TGS_data/test_data/task02/benchmark_results/uniform_20250510_113707/run_1BV_1_seq1_SVtable.csv \
