...
#SBATCH -N 1 -c 32
#SBATCH --mem=40G
#SBATCH --output=/storage01/users/s1155146014/TGS/code/task02/wave_TR_%j.out
#SBATCH --error=/storage01/users/s1155146014/TGS/code/task02/wave_TR_%j.err
#SBATCH -p chpc
...
RESULT_DIR="${RESULT_BASE}/wave_TR_${TIMESTAMP}"
mkdir -p ${RESULT_DIR}
...
for i in {1..10}; do
    ...
    bvsim \
        ...
        -p_del_region 0.810 \
        -p_ins_region 0.828 \
        -region_bed_url /storage01/users/s1155146014/BVSim/empirical/hg19/chr21_TR_unique.bed
